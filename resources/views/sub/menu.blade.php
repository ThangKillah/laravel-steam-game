                    ...
                    <nav class="nav">
                        <ul>
                                    ...
                                    <li>
                                        <div class="container">
                                            <div class="row">
                                                <div class="col">
                                                    <div class="img">
                                                        <a href="game-post.html"><img src="{{ asset('img/menu/menu-1.jpg') }}" alt="Last of Us: Part 2"></a>
                                                ...
                                                <div class="col">
                                                    <div class="img">
                                                        <a href="game-post.html"><img src="{{ asset('img/menu/menu-2.jpg') }}" alt="Injustice 2"></a>
                                                ...
                                                <div class="col">
                                                    <div class="img">
                                                        <a href="game-post.html"><img src="{{ asset('img/menu/menu-3.jpg') }}" alt="Bioshock: Infinite"></a>
                                                ...
                                                <div class="col">
                                                    <div class="img">
                                                        <a href="game-post.html"><img src="{{ asset('img/menu/menu-4.jpg') }}" alt="Batman: Arkham Knight"></a>
                                                        <span class="badge badge-ps4">PS4</span>
                                                    </div>
                                                ...
                                                <div class="col">
                                                    <div class="img">
                                                        <a href="game-post.html"><img src="{{ asset('img/menu/menu-5.jpg') }}" alt="Bioshock: Infinite"></a>
                            ...
                            <li class="has-dropdown mega-menu">
                                <a href="#">Components</a>
                                <ul style="background-image:url({{url('img/menu/mega-menu.png')}})">
                                    <li>
                                        <div class="container">
                                            <div class="row">
                                                <div class="col">
